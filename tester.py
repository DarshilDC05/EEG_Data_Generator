...
#plot the eeg-data
signal = np.loadtxt('file5_beta.txt')
signal_span = np.arange(0.005, 45.005, 0.005)
plt.subplot(2, 2, 1)
...
fft_value = fft_value[0: 4500]/4500
...
total_bandpoower = np.trapz(pow_spec_density, dx = frequency_resolution)

delta_bandpower = np.trapz(pow_spec_density[delta_range], dx = frequency_resolution)
theta_bandpower = np.trapz(pow_spec_density[theta_range], dx = frequency_resolution)
alpha_bandpower = np.trapz(pow_spec_density[alpha_range], dx = frequency_resolution)
beta_bandpower = np.trapz(pow_spec_density[beta_range], dx = frequency_resolution)
